...
Widget cardholderNameInput(TextEditingController cardholderNameController,
    ValueNotifier<String> cardholderName) {
  return Padding(
    ...
    child: TextFormField(
      ...
      decoration: InputDecoration(
        ...
        focusedBorder: UnderlineInputBorder(
            borderSide: BorderSide(color: Colors.grey.shade400)),
        labelText: 'Name',
        hintText: 'AOUer delivary',
        floatingLabelBehavior: FloatingLabelBehavior.always,
        suffixIcon: IconButton(
          onPressed: () {
            cardholderNameController.clear();
            cardholderName.value = 'AOUer delivary';
          },
...
Widget validThruInput(TextEditingController validThruController,
    ValueNotifier<String> validThru) {
  return Padding(
    padding: const EdgeInsets.symmetric(horizontal: 20.0),
    child: TextFormField(
