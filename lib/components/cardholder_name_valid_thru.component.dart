...
Widget cardholderNameValidThru(
    ...
    children: [
      ...
      Row(
        children: [
          ...
          SizedBox(width: 70, child: validThruDisplay(validThru))
        ],
      )
    ],
  );
...
Widget cardholderNameDisplay(ValueNotifier<String> cardholderName) {
  return ValueListenableBuilder<String>(
      ...
      builder: (BuildContext context, String cardholderName,
          Widget? cardholderNameWidget) {
        return Row(
